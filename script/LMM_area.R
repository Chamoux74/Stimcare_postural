...
p<- ggplot(data=dfanalysisO, aes(x= instant_mesure, y= area95, fill=condition) ) +
  geom_violin()+
...
residus <- residuals(M5, type="pearson",scaled=TRUE)
